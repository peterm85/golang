...
func (c *streamServiceClient) FetchResponse(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/main.StreamService/FetchResponse", opts...)
	if err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "main.StreamService",
	...
	Metadata: "grpc/server-stream/serverstr.proto",
}
